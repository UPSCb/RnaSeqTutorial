...
, then click on home > qa > raw and finally on the html file.
...
Run FastQC for your assigned read file. Compare the results with that of
your teammate. Does the QC looks fine to you or are there issues you
would address?
...
CPUs/threads to be used. The tool manual provides a comprehensive
...
for our PE sample example is as follows:
