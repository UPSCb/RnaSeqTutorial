...
gene expression, as we would like to perform a differential gene
expression study.
...
Using your STAR aligned BAM file, and the gff3 file available there: 
`~/share/Day1/data/reference/gff/Ptrichocarpa_v3.0_210_synthetic-gene-models-wo-introns.gff3`,
